...
public class Card {
	...
	public Card(int id, String number, String color, int playerId) {
        this.id = id;
        // Utiliza valueOf para obtener la enumeración correcta
        this.number = Number.valueOf(number.toUpperCase()); // Convierte a mayúsculas para garantizar la coincidencia
